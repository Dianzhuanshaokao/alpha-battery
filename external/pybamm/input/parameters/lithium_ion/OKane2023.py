...
def graphite_cracking_rate_Ai2020(T_dim):
    ...
    """
    k_cr = pybamm.Parameter(
        "Negative electrode cracking rate factor [m.(Pa.m0.5)-m_cr]"
    )
...
def cracking_rate_Ai2020(T_dim):
    ...
    """
    k_cr = pybamm.Parameter(
        "Positive electrode cracking rate factor [m.(Pa.m0.5)-m_cr]"
    )
...
def get_parameter_values():
    ...
    return {
        ...
        "Negative electrode cracking rate factor [m.(Pa.m0.5)-m_cr]": 3.9e-20,
        ...
        "Positive electrode cracking rate factor [m.(Pa.m0.5)-m_cr]": 3.9e-20,
